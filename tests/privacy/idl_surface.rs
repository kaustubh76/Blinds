...
const ALLOW: &[(&str, &str, &str, &str)] = &[
    ...
    // the collateral schedule: per-listing public parameters
    ("window_credit", "type", "ListingParams", "price_source"),
    ("window_credit", "type", "ListingParams", "haircut_bps"),
    ("window_credit", "type", "ListingParams", "max_price_age"),
    ("window_credit", "type", "ListingParams", "max_publish_age_secs"),
    ("window_credit", "account", "Listing", "price_source"),
    ("window_credit", "account", "Listing", "haircut_bps"),
    ("window_credit", "account", "Listing", "max_price_age"),
    ("window_credit", "account", "Listing", "max_publish_age_secs"),
    ("window_credit", "account", "Listing", "decimals"),
    ("window_credit", "account", "Listing", "bump"),
